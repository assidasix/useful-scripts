...
Usage: ./stress-test.sh [-a ADDRESS] [-c CONCURRENCY] [-r REQUESTS] [-X HTTP_METHOD] [-d BODY] [-H HEADERS] [-u USER]
Params:
...
while getopts ":a:c:r:h:u:X:d:H:" opt; do
  case $opt in
    a)
      ADDRESS=$OPTARG
      ;;
